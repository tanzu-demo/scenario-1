...
```json
{
  "appSsoServerLabel" : "'name: authserver'",
  "artifactId" : "customer-profile-ui",
  "buildTool" : "maven",
  "groupId" : "com.example",
  "includeAppSsoIntegration" : true,
  "javaVersion" : "17",
  "liveUpdateIDESupport" : true,
  "packageName" : "com.example.customerprofile.ui",
  "projectName" : "frontend",
  "sourceRepositoryPrefix" : "dev.local",
  "workloadURL" : "https://frontend.scenario1.35.192.91.18.nip.io"
}
```
## Log
```
...
┃ ┃ ┃ Debug Adding symbol packageDirectory with value 'com/example/customerprofile/ui'
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'customer-profile-ui'
...
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [java-server-side-ui->customer-profile-ui]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol workloadName with value 'customer-profile-ui'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug FRAGMENT_README.md didn't match [**/client-registration.yaml, **/client-registration-claim.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[4].delegate.transformations[0].sources[0].in.validated.delegate.transformations[0].sources[0].delegate.transformations[1] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [<my-workload-url>->https://frontend.sce...(truncated), <auth-server-selector>->'name: authserver', <my-workload>->customer-profile-ui]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ╺ engine.transformations[0].validated.delegate.in.transformations[4].delegate.transformations[0].sources[0].in.validated.delegate.transformations[0].sources[1].delegate.transformations[1] (OpenRewriteRecipe)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[4].delegate.transformations[0].sources[0].in.validated.delegate.transformations[0].sources[2] (Combo)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ engine.transformations[0].validated.delegate.in.transformations[4].delegate.transformations[0].sources[0].in.validated.delegate.transformations[0].sources[2].delegate (Chain)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Running Chain(Include, ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[4].delegate.transformations[0].sources[0].in.validated.delegate.transformations[0].sources[2].delegate.transformations[0] (Include)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Will include [README.md]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .grype.yaml didn't match [README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/javaserversideui/web/IndexController.java didn't match [README.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [README.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[4].delegate.transformations[0].sources[0].in.validated.delegate.transformations[0].sources[2].delegate.transformations[1] (ReplaceText)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw didn't match [**/OidcUserController.java, **/OidcUserControllerTest.java, **/WebSecurityConfiguration.java, **/TestWebSecurityConfiguration.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/client-registration-claim.yaml didn't match [**/OidcUserController.java, **/OidcUserControllerTest.java, **/WebSecurityConfiguration.java, **/TestWebSecurityConfiguration.java] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/OidcUserController.java, **/OidcUserControllerTest.java, **/WebSecurityConfiguration.java, **/TestWebSecurityConfiguration.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/client-registration.yaml didn't match [**/OidcUserController.java, **/OidcUserControllerTest.java, **/WebSecurityConfiguration.java, **/TestWebSecurityConfiguration.java] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.properties didn't match [**/OidcUserController.java, **/OidcUserControllerTest.java, **/WebSecurityConfiguration.java, **/TestWebSecurityConfiguration.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java didn't match [Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/styles/bootstrap-custom.css didn't match [Tiltfile] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->customer-profile-ui]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[6].delegate.transformations[0].sources[0].validated.delegate.transformations[0].sources[0].delegate.transformations[2] (ReplaceText)
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/styles/bootstrap-custom.css didn't match [DEPLOYING.md] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java didn't match [DEPLOYING.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java didn't match [DEPLOYING.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java didn't match [DEPLOYING.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->customer-profile-ui]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[6].delegate.transformations[0].sources[0].validated.delegate.transformations[0].sources[1].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local->dev.local]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/javaserversideui/web/IndexControllerTest.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/client-registration-claim.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/static/styles/bootstrap-custom.css matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .tanzuignore matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug LICENSE matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .grype.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/client-registration.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug catalog/catalog-info.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug .mvn/wrapper/maven-wrapper.properties matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug config/workload.yaml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/vmware/tap/accelerators/javaserversideui/ApplicationTest.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/vmware/tap/accelerators/javaserversideui/Application.java matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/application.yml matched [**] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug pom.xml matched [**] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java didn't match [**/com/vmware/tap/accelerators/javaserversideui/**/*.java] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/IndexControllerTest.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/ApplicationTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/Application.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/IndexController.java didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/index.html didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/*.jar] -> excluded
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java didn't match [**/*.jar] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/IndexControllerTest.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/ApplicationTest.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/OidcUserController.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/TestWebSecurityConfiguration.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/Application.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/web/IndexController.java didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/resources/templates/index.html didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug mvnw.cmd didn't match [**/*.jar] -> included
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/customerprofile/ui/WebSecurityConfiguration.java didn't match [**/*.jar] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/test/java/com/example/customerprofile/ui/web/OidcUserControllerTest.java didn't match [**/*.jar] -> included
